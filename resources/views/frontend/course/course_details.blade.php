               ...
               <div class="course-details-content-wrap pt-90px">
                   ...
                   <div class="course-overview-card">
                       ...
                       <div class="collapse" id="collapseMore">
                           ...
                           <p class="pb-2 fs-15">{{ $course->prerequisite }}</p>
                       </div>
                           ...
                           <div class="media media-card">
                               <div class="instructor-img">
                                   ...
                                   <ul class="pt-3 generic-list-item">
                                       ...
                                       <li><i class="mr-2 la la-play-circle-o text-color-3"></i> {{ count($instructorCourses) }} Courses</li>
                ...
                <div class="sidebar sidebar-negative">
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                <p class="pb-2 d-flex align-items-center">
                                    ...
                                    <p class="text-black card-price font-weight-bold">Ksh. {{ $course->selling_price }}  </p>&bnsp
                                    @else
                                    <span class="text-black fs-35 font-weight-semi-bold">Ksh. {{ $course->discount_price  }}</span>
                                    <span class="mx-1 before-price">Ksh. {{ $course->selling_price  }}</span>
                                    @endif
                        ...
                        <div class="buy-course-btn-box">
                            ...
                            <button type="button" class="mb-2 btn theme-btn w-100 theme-btn-white" onclick="buyCourse({{ $course->id }},'{{ $course->course_name }}', '{{ $course->instructor_id }}', '{{ $course->course_name_slug }}')"><i class="mr-1 la la-shopping-bag"></i> Buy this course</button>
                        </div>
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <ul class="pb-3 generic-list-item">
                                        <li><i class="mr-2 la la-play-circle-o text-color"></i>{{ $course->duration }} on demand hours</li>
                                        <li><i class="mr-2 la la-file text-color"></i>{{ $course->resourcs }} articles</li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="pb-4 mb-4 media media-card border-bottom border-bottom-gray">
                                ...
                                <div class="media-body">
                                    ...
                                    <span class="py-1 d-block lh-18 fs-14">{{ $related['user']['name'] }}</span>

                                    @if ($course->discount_price == NULL)
                                    <p class="text-black card-price font-weight-bold">Ksh. {{ $course->selling_price }}  </p>
                                    @else
                                    <p class="text-black card-price font-weight-bold">Ksh. {{ $course->discount_price }} <span class="before-price font-weight-medium">Ksh. {{ $course->selling_price }}</span></p>
                                    @endif
                                </div>
                            </div><!-- end media -->
                            @endforeach
        ...
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                ...
                <div class="card card-item">
                    ...
                    <div class="card-body">
                        <h6 class="mb-3 ribbon ribbon-blue-bg fs-14">{{ $inscourse->label }}</h6>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @if ($course->discount_price == NULL)
                            <p class="text-black card-price font-weight-bold">Ksh {{ $inscourse->selling_price }}  </p>
                            @else
                            <p class="text-black card-price font-weight-bold">Ksh {{ $inscourse->discount_price }} <span class="before-price font-weight-medium">Ksh {{ $inscourse->selling_price }}</span></p>
                            @endif
