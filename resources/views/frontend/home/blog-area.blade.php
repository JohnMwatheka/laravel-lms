            ...
            <div class="card card-item">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 d-flex justify-content-between align-items-center">
                        <a href="blog-single.html" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="ml-1 la la-arrow-right icon"></i></a>
                        <div class="share-wrap">
                            ...
                            <div class="shadow-sm cursor-pointer icon-element icon-element-sm share-toggle" title="Toggle to expand social icons"><i class="la la-share-alt"></i></div>
                        </div>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
