    ...
    <div class="card">
        <div class="p-4 card-body">
            ...
            <div class="form-group col-md-12">
                ...
                <textarea name="prerequisite" class="form-control" id="input11" placeholder="Prerequisites ..." rows="3">{{ $course->prerequisite }}</textarea>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('update.course.image') }}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="old_img" value="{{ $course->course_image }}" id="">
                <div class="row">
                    <div class="form-group col-md-6">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('update.course.video') }}" method="post" enctype="multipart/form-data">
                @csrf
                 ...
                 <div class="row">
                    <div class="form-group col-md-6">
                        <label for="input2" class="form-label">Update Intro video </label>
