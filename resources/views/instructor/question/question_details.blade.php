    ...
    <div class="page-content">
        <div class="chat-wrapper">
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="javascript:;" class="list-group-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="chat-time">{{ Carbon\Carbon::parse($question->created_at)->format('h:i A') }}
                                            </div>
                                        </div>
                                    </a>
                                </div>
            ...
            <div class="chat-content">
                <div class="chat-content-leftside">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2">
                            <p class="mb-0 chat-time">{{ $question->subject }}, {{ Carbon\Carbon::parse($question->created_at)->format('h:i A') }}</p>
                    ...
                    <div class="chat-content-rightside">
                        <div class="d-flex ms-auto">
                            <div class="flex-grow-1 me-2">
                                <p class="mb-0 chat-time text-end">you, {{ Carbon\Carbon::parse($rep->created_at)->format('h:i A') }}</p>
            ...
            <form action="{{ route('instructor.reply') }}" method="POST">
                ...
                <input type="text" name="qid" value="{{ $question->id }}" hidden>
                <input type="text" name="course_id" value="{{ $question->course->id }}" hidden>
                <input type="text" name="user_id" value="{{ $question->user->id }}" hidden>
                <input type="text" name="instructor_id" value="{{ $profileData->id }}" hidden>

                <div class="chat-footer d-flex align-items-center">
                    <div class="flex-grow-1 pe-2">
                        <div class="input-group">	<span class="input-group-text"><i class='bx bx-smile'></i></span>
                            <input type="text" class="form-control"  name="question" placeholder="Type a message" required>
                        </div>
                    </div>
                    <div class="chat-footer-menu"> 
                        <button type="submit" class="border-0"><i class="fadeIn animated bx bx-share"></i> Reply</button>
